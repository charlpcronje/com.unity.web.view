package com.gamezboost.webview;
...
public class PopUpWebView {
    ...
    public static void PopUpWebView(final Activity activity, final String WebUrl, final boolean isFullScreen, final int width, final int height) {
        activity.runOnUiThread(new Runnable() {
            public void run() {
                ...
                RelativeLayout.LayoutParams wvarams = new RelativeLayout.LayoutParams(-1, -1);
